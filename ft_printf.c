...
/*   Updated: 2024/10/19 11:09:18 by ipuig-pa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	printf("count: %i\n", printf("PRINTF:: c: %c, s: %s, p: %s, d: \
	%d, i: %i, u: %u, x: %x, X: %X, %%,", c, s, p, i, i, u, u, u));
	ft_printf("count: %i\n", ft_printf("PRINTF:: c: %c, s: %s, p: %s, \
	d: %d, i: %i, u: %u, x: %x, X: %X, %%,", c, s, p, i, i, u, u, u));
	return (0);
}*/